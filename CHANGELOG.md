...
### Improvements
- Bump `rand` 0.9.2 → 0.9.4 and 0.8.5 → 0.8.6 (RUSTSEC-2026-0097), `tokio` → 1.52.3, plus in-range lockfile updates
- Add comprehensive examples demonstrating core KubeMQ patterns and operations
